...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   apfwkr      10/25/23 - CI# 35944776 of chenxma_bug-33433265 .
   apfwkr      10/25/23 - CI# 35944776
   apfwkr      10/25/23 - apfwkr_ci_backport_33433265_19.22.0.0.240116dbru from
   apfwkr      04/12/23 - CI# 35282058 of jcremoni_bug-34154060 .
   apfwkr      04/12/23 - CI# 35282058
   apfwkr      05/30/22 - Backport
                          apfwkr_blr_backport_33690676_19.13.0.0.211019dbru
   anitap      03/21/22 - Proj 93526: Backport OAUTH support
   anitap      11/16/21 - Proj 84234: bearer token and dblink support
   prramakr    10/13/21 - Backport prramakr_proj89657 from main
   anitap      09/15/21 - Proj 84234: Backport IAM client changes 
   apfwkr      04/11/22 - Backport vjitta_bug-33690676 from main
...
#ifndef ORATYPES 
#include <occi/oratypes.h> 
#endif
 
#ifndef OCIDFN
#include <occi/ocidfn.h>
#endif

#ifndef OCIVER_ORACLE
#include <occi/ociver.h>
#endif
...
#define OCI_ATTR_SODA_SAMPLE_PCT                630
#define OCI_ATTR_SODA_SAMPLE_SEED               631
#define OCI_ATTR_SODA_SAMPLE_METHOD             632
...
/* OAUTH2 bearer token new attributes */
...
/* The following are possible values to be set for key validation */
...
/* The following are possible values to be set for sampling method */
...
#define OCI_FNCODE_MAXFCN                 232   /* maximum OCI function code */
...
#include <occi/ociextp.h>
#endif

#include <occi/ociapr.h>
#include <occi/ociap.h>

#ifndef OCIXMLDB_ORACLE
#include <occi/ocixmldb.h>
#endif

#ifndef OCI8DP_ORACLE
#include <occi/oci8dp.h>         /* interface definitions for the direct path api */
#endif
